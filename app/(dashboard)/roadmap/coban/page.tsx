...
export default function CobanRoadmapPage() {
  ...
  const filteredUnits = smartStart1Units.filter((unit) => unit.namespace === "primary_data");
    ...
    <div className="min-h-screen p-6 md:p-8" style={{ fontFamily: "'Quicksand', sans-serif" }}>
      ...
      >
        ...
        <div className="flex items-center gap-6">
          <Image src="/coban.png" alt="Cơ Bản" width={120} height={120} className="drop-shadow-2xl" />
          <div>
            <motion.h1
            ...
            <p className="text-white/60 text-base">Cấp độ A1 - Nâng cao kiến thức cơ bản</p>
          </div>
        </div>
