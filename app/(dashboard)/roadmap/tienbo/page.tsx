...
export default function TienBoRoadmapPage() {
    ...
    <div className="min-h-screen p-6 md:p-8" style={{ fontFamily: "'Quicksand', sans-serif" }}>
      ...
      >
        ...
        <div className="flex items-center gap-6">
          <Image src="/tienbo.png" alt="Tiến Bộ" width={120} height={120} className="drop-shadow-2xl" />
          <div>
            <motion.h1
            ...
            <p className="text-white/60 text-base">Cấp độ A2 - Phát triển kỹ năng giao tiếp</p>
          </div>
        </div>
