...
export default function ChuyenGiaRoadmapPage() {
  ...
  const filteredUnits = smartStart1Units.filter((unit) => unit.namespace === "highschool_data");
    ...
    <div className="min-h-screen p-6 md:p-8" style={{ fontFamily: "'Quicksand', sans-serif" }}>
      ...
      >
        ...
        <div className="flex items-center gap-6">
          <Image src="/chuyengia.png" alt="Chuyên Gia" width={120} height={120} className="drop-shadow-2xl" />
          <div>
            <motion.h1
            ...
            <p className="text-white/60 text-base">Cấp độ B1 - Thành thạo tiếng Anh</p>
          </div>
        </div>
