...
export default function TapSuRoadmapPage() {
  ...
  // Filter units for A1 level (Tập Sự)
  const filteredUnits = smartStart1Units.filter(
    (unit) => unit.namespace === "primary_data"
  );
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-white/60 text-base">
              Cấp độ A1 - Bắt đầu hành trình học tiếng Anh
            </p>
          </div>
        </div>
    ...
    >
      ...
      >
        <div className="flex items-start gap-4">
          ...
          >
            {!isUnlocked && (
              <Lock className="size-6 absolute" />
            )}
