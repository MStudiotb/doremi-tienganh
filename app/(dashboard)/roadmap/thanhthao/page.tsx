...
export default function ThanhThaoRoadmapPage() {
    ...
    <div className="min-h-screen p-6 md:p-8" style={{ fontFamily: "'Quicksand', sans-serif" }}>
      ...
      >
        ...
        <div className="flex items-center gap-6">
          <Image src="/thanhthao.png" alt="Thành Thạo" width={120} height={120} className="drop-shadow-2xl" />
          <div>
            <motion.h1
            ...
            <p className="text-white/60 text-base">Cấp độ B1 - Giao tiếp tự tin</p>
          </div>
        </div>
